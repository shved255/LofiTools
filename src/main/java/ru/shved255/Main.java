...
import ru.shved255.tools.bot.BotJoiner;
import ru.shved255.tools.download.Downloader;
	...
	public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
			...
			System.out.println("");
			    ...
			    System.out.print("6. Minecraft bots                     ||  Боты майнкрафт, специально оптимизированны. (полу рабочие, ккал (1.20.2 version))\n");	
			    System.out.print("7. Download avatar		      ||  Выгрузка аватакру с сервера.\n");
			    System.out.print("8. Exit			              ||  Выход из приложения.\n");
			    System.out.println("");
